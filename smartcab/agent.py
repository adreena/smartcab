...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.trial_number = 0
        self.initial_actions_Qvalue = {}
        for action in self.valid_actions:
            self.initial_actions_Qvalue[action] = 0.0

        waypoints_states = ['forward', 'left', 'right']
        light_states = ['green', 'red']
        oncoming_states = ['None', 'left', 'right', 'forward']
        right_states = ['None', 'left', 'right', 'forward'] 
        all_states_keys = map('-'.join, itertools.product(waypoints_states, light_states, oncoming_states, right_states))
        for state_key in all_states_keys:
            self.Q[state_key] = self.initial_actions_Qvalue.copy()
